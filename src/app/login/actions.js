...
export async function handleOAuth(provider) {
	...
	const redirectURL = process.env.NEXT_PUBLIC_SUPABASE_REDIRECT_URL ? `${process.env.NEXT_PUBLIC_SUPABASE_REDIRECT_URL}/auth/callback` : "http://localhost:3000/auth/callback";

	console.log(process.env.NEXT_PUBLIC_SUPABASE_REDIRECT_URL)
