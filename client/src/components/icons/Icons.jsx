...
import { UserRound, Bold, Underline, Italic, Heading1, Heading2, Heading3, List, ListOrdered, TextQuote, Image, AArrowDown, AArrowUp, LinkIcon, TrashIcon } from "lucide-react";
...
export function GoogleIcon({ className, size }) {
    return (
        <svg fontSize={size} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
...
export function GithubIcon({ className, size }) {
    return (
        <svg fontSize={size} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
